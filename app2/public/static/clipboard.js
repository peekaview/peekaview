...
window.addEventListener("DOMContentLoaded", () => {
    electron.ipcRenderer.on('pasteFromFile', async function (e, args) {
        ...
        if (obj.filecontent.startsWith('data:image/')) {
            ...
            div.style.cssText = 'background-image: url(assets/icons/' + extension + '.svg); background-repeat: no-repeat; background-position-x: right;  max-height: 150px;  max-width: 150px;';
