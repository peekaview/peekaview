...
<template>
  <Toolbar ref="toolbar" class="main-toolbar" :collapsible="!inBrowser" :draggable="draggable" poll-size @on-collapse="onCollapse">
    ...
    <template v-if="!inBrowser">
      ...
      <div class="btn btn-sm btn-secondary" title="Show invite link" style="width: 30px" @click="$emit('show-sharing-active')">
        <svg width="16px" height="16px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
