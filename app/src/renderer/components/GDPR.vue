<template>
  <div class="info-container">
    <div class="panel">
      ...
      <h2>Grundlegendes</h2>
      <p>Diese Datenschutzerklärung soll die Nutzer dieser Website über die Art, den Umfang und den Zweck der Erhebung und Verwendung personenbezogener Daten durch den Websitebetreiber LimTec GmbH, Halderstr 16, 86150 Augsburg informieren.</p>
      ...
      86150 Augsburg<br>
      Deutschland<br>
      Tel.: +49 (0)821 - 32871103<br>
      E-Mail: datenschutz@limtec.de<br>
      Website: www.limtec.de</p>
      ...
      <h2>Zugriffsdaten</h2>
      <p>Wir, der Websitebetreiber, erheben aufgrund unseres berechtigten Interesses (s. Art. 6 Abs. 1 lit. f. DSGVO) Daten über Zugriffe auf die Website und speichern diese als "Server-Logfiles" auf dem Server der Website ab. Folgende Daten werden so protokolliert:</p>
      ...
      <p>Für die Langzeitarchivierung und Erhebung von Zugriffsstatistiken werden die darin gespeicherten IP-Adressen anonymisiert, indem die beiden hinteren Adressblöcke durch 0 ersetzt werden.</p>
      ...
      <p>Nach ausdrücklicher Erlaubnis der betreffenden Nutzer und unter Einhaltung der geltenden Datenschutzbestimmungen, vearbeiten wir im Rahmen des Bestellprozesses oder bei Nutzung des Kontaktformulars personenbezogene Daten wie Vorname, Nachname, IP-Adresse, E-Mail-Adresse, Wohnort, Postleitzahl und bei Erteilung einer Einzugsermächtigung ihre Bankverbindung. Die Verarbeitung der personenbezogenen Daten erfolgt aufgrund unseres berechtigten Interesses zur Erfüllung unserer vertraglich vereinbarten Leistungen und zur Optimierung unseres Online-Angebotes.</p>
