      ...
      <div class="panel share-options-stack">
        <div class="share-option primary">
          <div class="option-content">
            ...
            <button class="btn btn-primary btn-lg w-100" :disabled="disabled" @click="shareViaApp">
        ...
        <div class="share-option secondary">
          <div class="option-content">
            ...
            <button class="btn btn-outline-primary btn-lg w-100" :disabled="disabled" @click="$emit('openInBrowser')">
