...
document.addEventListener("wheel", onWheel as EventListener, { passive: false } as { passive: boolean })
document.addEventListener('keydown', onKeydown, false)
window.addEventListener('resize', onResize)
window.addEventListener('drop', onDrop)
window.addEventListener('dragover', onDragOver as EventListener, { passive: false } as { passive: boolean })
...
onBeforeUnmount(() => {
  ...
  document.removeEventListener('wheel', onWheel as EventListener, { passive: false } as { passive: boolean })
  document.removeEventListener('keydown', onKeydown)
  window.removeEventListener('resize', onResize)
  window.removeEventListener('drop', onDrop)
  window.removeEventListener('dragover', onDragOver as EventListener, { passive: false } as { passive: boolean })
